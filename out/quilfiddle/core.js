...
goog.require('quilfiddle.clojuremirror');
...
return cljs.js.eval_str.cljs$core$IFn$_invoke$arity$5(quilfiddle.core.st,in_str,cljs.core.cst$sym$fiddle$runtime,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$eval,cljs.js.js_eval,cljs.core.cst$kw$source_DASH_map,true,cljs.core.cst$kw$ns,cljs.core.cst$sym$fiddle$runtime], null),(function (p__6399){
var map__6400 = p__6399;
var map__6400__$1 = ((((!((map__6400 == null)))?((((map__6400.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6400.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6400):map__6400);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6400__$1,cljs.core.cst$kw$error);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6400__$1,cljs.core.cst$kw$value);
...
var cm_6408 = (function (){var G__6404 = document.getElementById("editor");
var G__6405 = {"gutters": ["CodeMirror-linenumbers"], "matchBrackets": true, "value": quilfiddle.core.default_code, "mode": "clojure", "extraKeys": {"Cmd-Enter": ((function (G__6404){
return (function (p1__6402_SHARP_){
return quilfiddle.core.eval_sexp(p1__6402_SHARP_);
});})(G__6404))
, "Ctrl-Enter": ((function (G__6404){
return (function (p1__6403_SHARP_){
return quilfiddle.core.eval_sexp(p1__6403_SHARP_);
});})(G__6404))
, "Tab": "autocomplete"}, "theme": "paraiso-dark", "autofocus": true, "styleActiveLine": true, "autoCloseBrackets": true};
return CodeMirror(G__6404,G__6405);
})();
var G__6406_6409 = "clojure";
var G__6407_6410 = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$hint_DASH_pattern,/[\w\-\>\:\*\$\?\<\!\+\.\\/foo]/], null));
CodeMirror.extendMode(G__6406_6409,G__6407_6410);
quilfiddle.core.load = (function quilfiddle$core$load(lib,cb){
var G__6412 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$lang,cljs.core.cst$kw$clj,cljs.core.cst$kw$source,[cljs.core.str(cljs.core.cst$sym$quil$core),cljs.core.str(cljs.core.cst$sym$quil$middleware)].join('')], null);
return (cb.cljs$core$IFn$_invoke$arity$1 ? cb.cljs$core$IFn$_invoke$arity$1(G__6412) : cb.call(null,G__6412));
});
cljs.js.eval_str.cljs$core$IFn$_invoke$arity$5(quilfiddle.core.st,[cljs.core.str("(ns fiddle.runtime (:require [quil.core :as q] [quil.middleware :as m])) "),cljs.core.str(quilfiddle.core.default_code)].join(''),cljs.core.cst$sym$fiddle$runtime,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$eval,cljs.js.js_eval,cljs.core.cst$kw$load,quilfiddle.core.load,cljs.core.cst$kw$ns,cljs.core.cst$sym$fiddle$runtime,cljs.core.cst$kw$source_DASH_map,true], null),(function (p__6413){
var map__6414 = p__6413;
var map__6414__$1 = ((((!((map__6414 == null)))?((((map__6414.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6414.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6414):map__6414);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6414__$1,cljs.core.cst$kw$error);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6414__$1,cljs.core.cst$kw$value);
if(cljs.core.not(error)){
return console.log(value);
} else {
return console.error(error);
