...
var vec__14974 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14974,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14974,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14974,(2),null);
var vec__14975 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14975,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14975,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14975,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__14976,p__14977){
var vec__14980 = p__14976;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14980,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14980,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14980,(2),null);
var vec__14981 = p__14977;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14981,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14981,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14981,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__14982_SHARP_){
return (p1__14982_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__14983_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__14984_SHARP_,angle_lr),angle_ud);
...
var map__14991 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__14991__$1 = ((((!((map__14991 == null)))?((((map__14991.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14991.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14991):map__14991);
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14991__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14991__$1,cljs.core.cst$kw$straight);
var temp__4423__auto__ = (function (){var pred__14993 = cljs.core._EQ_;
var expr__14994 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((pred__14993.cljs$core$IFn$_invoke$arity$2 ? pred__14993.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$w,expr__14994) : pred__14993.call(null,cljs.core.cst$kw$w,expr__14994)))){
return straight;
} else {
if(cljs.core.truth_((pred__14993.cljs$core$IFn$_invoke$arity$2 ? pred__14993.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$s,expr__14994) : pred__14993.call(null,cljs.core.cst$kw$s,expr__14994)))){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__14993.cljs$core$IFn$_invoke$arity$2 ? pred__14993.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__14994) : pred__14993.call(null,quil.middlewares.navigation_3d.space,expr__14994)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((pred__14993.cljs$core$IFn$_invoke$arity$2 ? pred__14993.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$z,expr__14994) : pred__14993.call(null,cljs.core.cst$kw$z,expr__14994)))){
return up;
} else {
if(cljs.core.truth_((pred__14993.cljs$core$IFn$_invoke$arity$2 ? pred__14993.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$d,expr__14994) : pred__14993.call(null,cljs.core.cst$kw$d,expr__14994)))){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((pred__14993.cljs$core$IFn$_invoke$arity$2 ? pred__14993.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$a,expr__14994) : pred__14993.call(null,cljs.core.cst$kw$a,expr__14994)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__4423__auto__,map__14991,map__14991__$1,up,straight){
return (function (p1__14985_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__14985_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__4423__auto__,map__14991,map__14991__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([initial_state,p1__14996_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__15008 = options;
var G__15009 = ((function (G__15008,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__15008,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__15008,G__15009) : rotate_on.call(null,G__15008,G__15009));
})();
...
var map__15010_15019 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__15010_15020__$1 = ((((!((map__15010_15019 == null)))?((((map__15010_15019.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15010_15019.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15010_15019):map__15010_15019);
var vec__15011_15021 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15010_15020__$1,cljs.core.cst$kw$straight);
var c_x_15022 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15011_15021,(0),null);
var c_y_15023 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15011_15021,(1),null);
var c_z_15024 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15011_15021,(2),null);
var vec__15012_15025 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15010_15020__$1,cljs.core.cst$kw$up);
var u_x_15026 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15012_15025,(0),null);
var u_y_15027 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15012_15025,(1),null);
var u_z_15028 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15012_15025,(2),null);
var vec__15013_15029 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15010_15020__$1,cljs.core.cst$kw$position);
var p_x_15030 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15013_15029,(0),null);
var p_y_15031 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15013_15029,(1),null);
var p_z_15032 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15013_15029,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_15030,p_y_15031,p_z_15032,(p_x_15030 + c_x_15022),(p_y_15031 + c_y_15023),(p_z_15032 + c_z_15024),u_x_15026,u_y_15027,u_z_15028);
...
var G__15015 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__15016 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__15015,G__15016) : key_pressed.call(null,G__15015,G__15016));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__15017 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__15018 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__15017,G__15018) : rotate_on_fn.call(null,G__15017,G__15018));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
